...
- Professional nurses (4-year degree or diploma)
- Enrolled nurses (2-year diploma)
- Enrolled auxiliary nurses (1-year certificate)
- Nurse practitioners (advanced practice — increasingly recognised)
- Community service: 1 year compulsory after qualification
...
- Approximately 70 open schemes and 21 restricted/closed schemes registered
- Enforces Prescribed Minimum Benefits (PMBs)
- Investigates scheme complaints
- Publishes annual Industry Report (key benchmarking data)
- Accredits managed care organisations and brokers
...
- A single national purchaser (NHI Fund) that buys healthcare services on behalf of all South Africans
- Benefits package to be determined by a Benefits Advisory Committee
- Primary healthcare: contracted through Contracting Units for Primary Healthcare (CUPs) — GP practices and clinics
- Hospital services: contracted from accredited public and private providers
- Medical aid schemes: role significantly curtailed (may only cover benefits outside the NHI benefit package)
- Tax-funded: payroll tax (employer + employee), surcharge on personal income tax, elimination of medical tax credits
...
- Revenue predominantly from medical aid (70–80%) and managed care organisations (MCOs)
- Key cost drivers: nurses (shortage-driven inflation), electricity (load shedding → generators → diesel), medical consumables (USD-denominated imports)
- Theatre revenue per case significantly higher than ward revenue — theatre utilisation drives profitability
- PMB obligation: private hospitals must treat PMB conditions regardless of benefit exhaustion
