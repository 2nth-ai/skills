...
- Mental health care users retain rights including dignity, privacy, informed consent, and appeal
- Involuntary care is a last resort — least restrictive care principle
- Community-based care is preferred over institutionalisation
- Mental Health Review Boards (MHRBs) provide independent oversight
...
- User has legal capacity and consents to care
- Standard healthcare admission process applies
- User retains right to discharge themselves (except where clinical risk warrants reclassification)
- Head of Establishment must be informed if voluntary user wishes to leave against medical advice and clinician believes it would result in serious harm
...
- Triggered when a person: is a danger to themselves or others, is mentally ill, AND requires immediate care
- A police officer or nursing professional may take the person to a designated health establishment
- Formal 72-hour assessment must commence immediately on arrival
- S40 is not a substitute for the full involuntary admission process — it is a bridge to get the person assessed urgently
...
- Males die by suicide at 3–4× the rate of females (males use more lethal means)
- Females attempt at higher rates
- Youth (15–24) and older adults (65+) are high-risk groups
- Methods: hanging (most common), firearms, pesticide ingestion (rural)
- SADAG (South African Depression and Anxiety Group) crisis line: 0800 456 789 (24hr)
- Lifeline SA: 0861 322 322

**Suicide risk in SA context:**
- Unemployment (SA unemployment ~33%) is a documented risk factor
- GBV survivors have elevated suicide risk
- LGBTQI+ individuals face elevated risk in context of social stigma
- HIV diagnosis without adequate psychosocial support increases risk — integrated mental health support at ART initiation is evidence-based practice
...
**Treatment resources:**
- SANCA (SA National Council on Alcoholism and Drug Dependence): 0861 4 SANCA — inpatient rehabilitation referral
- Central Drug Authority (CDA): national policy coordination
- NICRO (National Institute for Crime Prevention and Reintegration): community reintegration
- State-funded rehabilitation: Stikland Hospital (WC), Weskoppies (GP), Umzimkhulu (KZN) — beds severely limited

**FASD (Foetal Alcohol Spectrum Disorder):**
SA Western Cape has the highest reported FASD prevalence in the world (~11–17% in some communities). This is a public health emergency with lifelong neurodevelopmental consequences. Prevention requires upstream intervention on alcohol availability, not only individual behaviour change.
...
- **Norm**: 23 psychiatric beds per 100,000 population (NDoH guideline)
- Reality: Most districts are significantly below norm; some rural districts have zero psychiatric beds
- Functions: acute stabilisation, 72-hour assessments under MHCA, initiation of pharmacotherapy, MHRB applications
- Referral from: PHC clinics, ED, CMHT, police (s40)
- Referral to: Regional hospital (if not responding to treatment), specialised hospital (long-stay)

### Level 3 — Regional Hospital Acute Psychiatric Unit

- Handles complex and treatment-resistant presentations
- Access to consultation psychiatry (for medical comorbidities)
- Electro-Convulsive Therapy (ECT) — available at some regional and all central hospitals
- Functions as intermediary between district acute care and specialised long-stay
...
- Medical aid schemes must cover psychiatric admissions as a Prescribed Minimum Benefit (PMB) condition (Regulation 8 of the Medical Schemes Act)
- PMB for mental health: acute stabilisation — minimum 21 days inpatient (CMS guideline)
- In practice, schemes aggressively manage psychiatric admissions; most authorise 7–14 days with case management
- Pre-authorisation required for all private psychiatric admissions
- Funders use DRG (Diagnosis-Related Group) or per diem funding models
- Common insurers in psychiatric space: Discovery Health, Bonitas, GEMS (Government Employees Medical Scheme)
...
- High rates of interpersonal violence (witnessing violence, being a victim)
- GBV — intimate partner violence, sexual assault
- Childhood trauma (adverse childhood experiences — ACEs)
- Community violence (especially Cape Flats, Johannesburg townships)
- SA police service members — operational trauma exposure
...
**Stopping rules:**
- WBC < 3.0 x 10^9/L: stop clozapine, monitor daily FBC, haematology consult
- Neutrophil count < 1.5 x 10^9/L: stop immediately, agranulocytosis protocol
- Neutrophil count < 0.5 x 10^9/L: medical emergency — G-CSF, haematology, isolation

**Other clozapine risks requiring monitoring:**
- Myocarditis (especially in first month): weekly troponin/ECG in some protocols
- Metabolic syndrome: weight, glucose, lipids — monthly for first 3 months
- Seizures (dose-related): EEG consideration at doses >500mg/day
- Constipation/ileus: bowel habit monitoring; laxatives prophylactically
...
- **PHC nurses trained in mhGAP** assess and manage depression, psychosis, alcohol use disorders, epilepsy, and suicide risk at clinic level
- **Psychiatric nurses** manage complex community cases, depot clinics, and MDT coordination without direct psychiatrist oversight
- **Social workers** conduct MHCA s33 applications and support MHRB processes
- **Clinical associates** (mid-level practitioners) manage mental health in district hospitals in some provinces
...
- Integrated School Health Programme (ISHP) includes mental health component — screening for learning disabilities, ADHD, emotional difficulties
- SASSA (South African Social Security Agency) interfaces: child grants, disability grants for severe psychiatric conditions
- School social workers are the primary referral pathway for learner mental health — but posts are severely under-funded
- SA Council for Educators (SACE) does not cover mental health first aid as a standard teacher competency — advocacy gap
...
- **S40 is not a stand-alone admission category**: S40 of the MHCA is an emergency conveyance provision — it must be followed by a full 72-hour assessment and, if continued, a formal s33 application. Holding a patient beyond 72 hours under "s40" without progressing the process is unlawful detention. This is a common compliance failure.
- **Clozapine without monitoring infrastructure is negligence**: Never initiate clozapine in a facility that cannot guarantee weekly FBC for the first 18 weeks. Many district hospitals that wish to initiate clozapine lack reliable lab turnaround — this must be resolved before first dose.
- **ICD-10 in legal/medicolegal documents**: SA courts and the MHRB require ICD-10 codes, not DSM-5. A medicolegal report using only DSM-5 terminology may be challenged. Know both systems.
- **Private medical aid PMB psychiatric days are not guaranteed 21 days**: The CMS PMB framework requires schemes to cover the PMB condition, not a fixed number of days. Schemes will manage to clinical necessity. Expect 7–10 days in practice; plan discharge and community care from day 1.
- **FASD is not ADHD**: FASD in SA is dramatically underdiagnosed and misdiagnosed as ADHD. Stimulants are less effective in FASD. A neurodevelopmental history including maternal alcohol exposure is essential before ADHD diagnosis in any child from a high-prevalence community.
- **mhGAP training without supervision erodes rapidly**: Nurses trained in mhGAP without ongoing clinical supervision revert to pre-training practice within 6–12 months. Training spend without supervision infrastructure is waste.
- **Lithium and dehydration**: In SA's climate, and during gastroenteritis (very common in children and adults), lithium levels can spike to toxic range within 24–48 hours. Sick-day rules (hold lithium, hydrate, seek care) must be explicitly counselled at every dispensing.
- **Life Esidimeni compliance obligation**: All provincial DoH mental health programmes are subject to the Arbitration Award conditions. Moving or discharging involuntary patients to non-accredited facilities is prohibited and a direct governance liability for facility and programme managers.

---

## See Also

- Mental Health Care Act 17 of 2002 (and Regulations — Government Gazette)
- NDOH National Mental Health Policy Framework and Strategic Plan 2023–2030
- SADAG (South African Depression and Anxiety Group): sadag.org / 0800 456 789
- SANCA (SA National Council on Alcoholism and Drug Dependence): sanca.org.za
- WHO mhGAP Intervention Guide v2.0 (adapted for SA)
- SAMRC Mental Health Research and Policy brief series
- Life Esidimeni Arbitration Award (Justice Moseneke) — 2018 — mandatory reading for mental health programme managers
- CMS (Council for Medical Schemes) PMB circular on mental health conditions
- GEPF Incapacity/Medical Boarding guidelines: gepf.co.za
- NICD mental health surveillance data (where applicable to communicable disease overlap — e.g. HIV-associated neurocognitive disorder)
- `/health/SKILL.md` — parent domain manifest
- `/health/public-health/SKILL.md` — epidemiology and PHC system complement
- `/health/clinical/SKILL.md` — clinical systems and protocols
