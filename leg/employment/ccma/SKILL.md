...
- **Unfair dismissal** (the most common claim)
- **Unfair labour practices** (unfair demotion, suspension, failure to promote)
- **Constructive dismissal** (employee resigns and claims working conditions were intolerable)
- **Automatically unfair dismissal** (dismissal for union membership, pregnancy, whistleblowing)
- **Severance pay disputes**
- **Mutual interest disputes** (wages, working conditions — precursor to industrial action)

The CCMA does **not** handle:
- Claims for monies owed (unpaid salary, leave pay — these go to the Labour Court or BCEA complaint)
- Disciplinary hearings
- Disputes about the terms of a contract (contractual claims go to ordinary civil courts)
...
- **30 days** of dismissal (unfair dismissal)
- **90 days** of the unfair labour practice (unfair labour practice)
...
**Common settlements**:
- Agreed separation package (weeks of remuneration per year of service, typically 2–4 weeks)
- Reinstatement (rare; usually avoided by the employer through a financial settlement)
- Withdrawal of the referral with or without payment
...
- Legal representatives are permitted (but not by right — must be agreed or granted)
- Evidence under oath
- Cross-examination permitted
- Outcome is binding

**Outcome options**:
- Reinstatement (the default remedy for unfair dismissal)
- Re-employment
- Compensation (maximum 12 months' remuneration for procedurally and substantively unfair dismissal; up to 24 months for automatically unfair dismissal)
...
- Gather all documentation: employment contract, disciplinary notices, hearing minutes, outcome letter
- Identify and brief witnesses (the person who chaired the hearing, the investigating officer)
- Prepare a bundle of documents for the commissioner
- Timeline of events from first warning to dismissal
- Evidence of progressive discipline (prior warnings still in effect)

### Common Employer Mistakes
| Mistake | Consequence |
|---------|------------|
| No written notice of disciplinary hearing | Procedurally unfair dismissal |
| Hearing chaired by the complainant | Procedurally unfair — must be independent |
| No right to representation at hearing | Procedurally unfair |
| Summary dismissal for a minor offence | Substantively unfair — sanction disproportionate |
| No opportunity to respond to charges | Procedurally unfair |
| Undocumented verbal warnings | Cannot prove progressive discipline |
| Failure to attend CCMA | Default award against employer |
...
- Arbitration is time-consuming (half to full day, often multiple sessions)
- Legal costs at arbitration are not recoverable (no costs order)
- The outcome at arbitration is unpredictable
- A settlement is confidential; an arbitration award is on the public record
