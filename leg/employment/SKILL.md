...
- Full name and occupation of employee
- Place of work
- Start date
- Ordinary hours of work and days of the week
- Wage and rate of payment
- Leave entitlement
- Notice period

### Additional Clauses That Protect the Business
- **Confidentiality**: All business information is confidential during and after employment
- **IP assignment**: Work created in the course of employment belongs to the employer
- **Non-solicitation**: Cannot solicit clients or employees for a defined period after leaving
- **Garden leave**: During notice period, employer may require employee not to attend work (prevents client poaching during transition)
- **Restraint of trade**: Limited geographic and time-bound restrictions on competitive activity
...
### Working Hours
- Ordinary hours: **45 hours per week** (9 hours/day for 5-day week; 8 hours/day for more than 5 days)
- Overtime: Maximum 10 hours/week at **1.5× the ordinary rate**
- Sunday work: **2× the ordinary rate** (or 1.5× if Sunday is an ordinary working day)
- Public holiday work: **2× the ordinary rate**
...
### Termination Pay
- Severance pay (retrenchment only): **1 week's remuneration per completed year of service**
- All outstanding leave must be paid out on termination
- Pro-rata bonus (if contractually entitled)
...
- The person works set hours or hours determined by the client
- The person has worked for the client for an average of 40 hours per month for 3 months
- The person forms an integral part of the business
- The person is economically dependent on the client
- The tools of the trade are provided by the client
- The person only works for one client
...
- **Misconduct**: Theft, dishonesty, insubordination, gross negligence, repeated lesser offences
- **Incapacity**: Poor performance (after counselling and opportunity to improve) or ill health
- **Operational requirements**: Retrenchment (fair process required — consultation, LIFO)
