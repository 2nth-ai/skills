...
- Employee creates in the course of employment → **employer owns** (Section 21(1)(d) of the Copyright Act 98 of 1978)
- Contractor / freelancer creates → **contractor owns** unless there is a written IP assignment
- AI-generated content → no copyright owner in South Africa (no human author)
...
- Application fee: ~R590 per class
- Processing time: 18–36 months (currently backlogged at CIPC)
- Duration: 10 years, renewable indefinitely
- Gives the owner exclusive rights to use the mark in the registered class in South Africa
...
- Search the CIPC trade marks register (free online)
- Search the internet and social media
- Search domain availability
- If clear, file the application before launch (not after)

### 3. Patents
Protection for inventions and technical innovations.

**Requires registration** — patents do not arise automatically.
- **Innovation patent**: New, inventive, and industrially applicable
- **Petty patent** (design): New and original design for a product
...
- Must be kept confidential (not widely disclosed)
- Must have commercial value by virtue of being secret
...
- Is all software created by employees or contractors with written assignments?
- Are trademarks registered in all key jurisdictions?
- Are there any open-source components with licence terms that affect commercial use?
- Are there any IP disputes or infringement claims?
- Does the company actually own the domain names, social media handles, and brand assets?
...
- Register all relevant domain name extensions (`.co.za`, `.com`, `.africa`)
- Register brand name on all major social media platforms before launch, even if not immediately active
- Use a company email address (not personal) for all registrations — access is lost when individuals leave
