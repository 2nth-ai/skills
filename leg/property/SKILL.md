...
- CPI-linked escalation (not fixed %)
- Escalation capped at 8%
- Escalation starting from the second anniversary (not year 1)

**Deposit**: Typically 1–3 months' rent held interest-free. Negotiate:
- Interest-bearing deposit (yours, not the landlord's)
- Reduction or waiver for creditworthy tenants or longer lease terms

**Gross vs Net Lease**:
- **Gross lease**: Rental includes rates, water, electricity, building insurance — simpler; you know your cost
- **Net lease**: You pay base rent **plus** proportional share of rates, levies, building insurance — hidden escalation risk; cap your exposure or get past actuals
...
- Using the premises for any other purpose is a breach
- A narrow clause restricts subletting and assignment
- Negotiate the widest permitted use that is honest (e.g., "technology and related services" rather than "web development")
...
- Require written consent (not to be unreasonably withheld)
- Charge a consent fee (2–4 weeks' rent is typical)
...
**Watch for**:
- Option must be exercised 6–12 months before expiry — set a calendar reminder the day you sign
- "Rental to be market-related" — negotiate a cap or agreed escalation formula instead
- Renewal at the landlord's discretion — not an option; walk away from this
...
- All rent for the balance of the lease term, or
- Rent until the landlord relets the space (whichever is earlier) — the landlord has a duty to mitigate
...
- [ ] Confirmed gross lettable area (GLA) with as-built floor plan — verify you're paying for what you're getting
- [ ] Rent-free fitting-out period negotiated and in the lease
- [ ] TIA amount, triggers, and payment terms confirmed
- [ ] Handover condition documented (photos taken on date of handover)
- [ ] Escalation rate and basis confirmed (fixed % vs CPI)
- [ ] Renewal option with notice period calendared
- [ ] Assignment and subletting consent terms acceptable
- [ ] Break clause dates calendared
- [ ] Personal guarantee capped and time-limited
- [ ] Rates, levies, and utility costs confirmed (gross vs net lease) and past actuals reviewed
- [ ] HVAC and maintenance obligations allocated
- [ ] Exit restoration obligations understood and costed
