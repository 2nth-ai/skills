...
- Take emotion out of it. Focus on the commercial outcome each party needs.
- Identify the zone of possible agreement: what are you both willing to accept?
- Settle in writing — a signed settlement agreement or exchange of emails confirming terms.

### 2. Letter of Demand
When direct negotiation fails or is refused, a formal letter of demand:
- States the legal basis for the claim
- Specifies the amount or remedy claimed
- Sets a deadline for response (7–14 days is standard)
- States the consequences of non-compliance (legal action)
...
- Choose a mediator with domain expertise (commercial disputes, construction, employment)
...
- The contract specifies arbitration (check your dispute resolution clause)
- Both parties agree to arbitrate
- Confidentiality is important
- A specialist arbitrator is preferred over a judge
...
- The dispute cannot be resolved any other way
- The precedent or principle is worth the cost
- There is an asset at risk that needs to be preserved urgently (use an interdict)

**SA Court hierarchy for commercial disputes**:
| Court | Jurisdiction |
|-------|-------------|
| Magistrate's Court | Claims up to R400,000 |
| Regional Magistrate's Court | Claims up to R600,000 |
| High Court | Any amount; complex matters |
| Supreme Court of Appeal | Appeals from High Court |
...
- What will it cost to get there (legal fees, management time, distraction)?
- What is the relationship value of the other party?
- What is the reputational risk of the dispute becoming public?
- Is there a settlement that meets your core commercial need without full litigation?
