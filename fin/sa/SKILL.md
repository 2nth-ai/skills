...
- **IFRS for SMEs**: Required for companies that are not publicly accountable and publish financial statements for external users
- **Full IFRS**: Required for listed companies and banks
- **Accounting Officer**: Required for private companies not requiring an audit
- **Independent Review**: Required for owner-managed companies meeting certain thresholds
- **Statutory Audit**: Required for public companies, state-owned entities, and large private companies
