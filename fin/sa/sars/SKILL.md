...
- Tax reference number (issued at company registration or separately via SARS branch)
- Bank account details for refunds
- Representative taxpayer (director or public officer) with valid South African ID

### Key eFiling Functions
- Submit ITR14 (company tax return)
- Submit VAT201 (VAT return)
- Submit EMP201 (monthly employer return)
- Submit EMP501 (employer reconciliation)
- Pay all tax obligations via eFiling or eBanking
- Request tax clearance certificates
- View account balance, correspondence, and audit notices
- Lodge objections and appeals
...
Required for:
- Government tenders (all tenders above the threshold)
- Foreign investment allowances
- Some banking and trade finance facilities
- Business licensing in certain industries
...
- Significant changes in income or deductions year-on-year
- Random selection
...
**Audit triggers**:
- High-risk industry flagged by SARS
- Third-party data mismatch (bank feeds, property deeds, UIF records)
- Whistleblower report
- Assessed loss claimed over multiple consecutive years
- Transfer pricing risk

**Best practice**:
- Maintain complete records for **5 years** from the date of submission
- Keep original tax invoices, bank statements, payroll records, and contracts
- Respond within the prescribed timeframe (non-response is deemed agreement)
- Engage a tax practitioner for substantive audits
...
- **Alternative Dispute Resolution (ADR)**: Facilitated by a SARS ADR facilitator — recommended first step for most disputes
- **Tax Board**: For disputes under R1 million — informal, relatively quick
- **Tax Court**: For larger disputes or where Tax Board decision is appealed
...
- Apply via eFiling or at a SARS branch
- Must submit supporting financial statements showing inability to pay
- Arrangement typically runs 12–24 months
- Compliance with all current obligations is required during the arrangement
