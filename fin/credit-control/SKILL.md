...
- Define standard terms (e.g., 30 days from invoice date)
- Assess the customer's creditworthiness:
  - Request bank references for significant credit limits
  - Check payment history from trade references
  - Review publicly available financial information for larger accounts
  - Use a credit bureau (TransUnion, Experian, Compuscan in South Africa) for high-risk or high-value customers

### Credit Application
For any customer with credit terms, a signed credit application on file:
- Business registration details (CIPC number)
- VAT number
- Physical and postal address
- Banking details (for debit order if applicable)
- Authorised signatory
- Agreement to your standard terms and conditions (including late payment interest)
...
- Handover to a collections attorney (Letter of Demand)
- Credit Bureau listing (for consumer debtors)
- Summons / Magistrate's Court claim (for amounts under R200,000)
- High Court action (for larger amounts)

### Bad Debt Write-Off
Write off as a bad debt (with VAT relief claim — Section 22(3) of VAT Act) after:
- All reasonable collection steps exhausted
- Legal proceedings concluded or cost-prohibitive
- Customer has been liquidated or sequestrated
...
- Interest at [2%] per month (or repo rate + x%) on overdue amounts
- The obligation is **only enforceable if included in the signed credit application or terms and conditions**
- Invoice the interest monthly once a balance is overdue
...
- The debt has been written off as irrecoverable in the accounting records
- More than **12 months** have elapsed since the date of the supply
