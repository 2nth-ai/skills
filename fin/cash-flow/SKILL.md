...
- Group debtors by payment terms and payment behaviour
- Identify slow payers and model their actual payment pattern, not their contracted terms
- Include deposits and advance payments when received

**Payments**: Based on supplier invoices + committed costs
- Fixed costs (rent, salaries, subscriptions) are predictable — plug directly
- Variable costs (production, materials) tied to revenue forecast
- Tax payments from the tax calendar (PAYE 7th, VAT 25th, provisional tax dates)
...
**To reduce DSO**:
- Invoice promptly (on delivery, not at month-end)
- Set clear payment terms and enforce them
- Send statements before the due date, not after
- Follow up on day 31, not day 60
- Offer small early payment discounts for key customers (e.g., 2% for payment within 7 days)
- Stop supplying clients with outstanding amounts beyond agreed terms
