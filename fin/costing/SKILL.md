...
- Raw materials
- Direct labour (time spent on a specific job)
- Subcontractor costs for a specific engagement
- Commissions on a specific sale
- Freight and delivery for a specific order
...
### Time-Based Costing
- Hourly cost per staff member = (Annual salary + employer costs) ÷ billable hours
- Multiply by hours spent on engagement
- Add direct costs (travel, software, subcontractors)
- Compare to revenue earned = Engagement gross profit
...
- Break-even analysis
- Pricing decisions (minimum price = variable cost per unit)
- Product mix decisions (prioritise highest contribution margin per unit of constrained resource)
...
**Allocation bases**:
- Direct labour hours (common in manufacturing and professional services)
- Direct labour cost
- Machine hours
- Square metres (for facility costs)
- Revenue (simple but can distort)
