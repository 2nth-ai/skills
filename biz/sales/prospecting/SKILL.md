...
**Firmographic**:
- Industry / vertical (where you win and where you don't)
- Company size: revenue range, headcount range
- Geography
- Stage: startup, scale-up, enterprise, public

**Technographic**:
- Current tools and systems (what they use that you integrate with or replace)
- Technical maturity signal (do they have an IT team? Engineering team?)

**Situational triggers** (companies in a situation where your solution is needed):
- Recent funding round
- New executive hire (especially in the relevant function)
- Recent expansion (new market, new product)
- Regulatory change affecting their industry
- Rapid headcount growth
- Public complaints about the problem you solve

**Negative ICP** (who to explicitly avoid):
- Industries or sizes where you consistently lose or churn
- Companies with procurement complexity that exceeds deal value
...
- LinkedIn Sales Navigator (firmographic + seniority filters)
- Intent data (companies researching relevant topics)
- Trigger events (funding, hiring, expansion news)
- CRM: look-alike to your best existing customers
...
- "Question about [Company]'s [function]"
...
| Day | Channel | Action |
|-----|---------|--------|
| 1 | Email | First touch — problem-led |
| 2 | LinkedIn | Connect request (no note) |
| 4 | Email | Follow-up — different angle (insight, not chase) |
| 6 | LinkedIn | Message if connected — brief, specific |
| 8 | Phone | Call + voicemail if no answer |
| 11 | Email | Case study or relevant content |
| 14 | Phone | Second call attempt |
| 18 | Email | Break-up email — "closing the loop" |
...
- State your name and company confidently
- Ask if you've caught them at a bad time (not "is this a good time" — frame for a yes)
- Lead with a specific, relevant observation — not a generic pitch
