...
- **CORS blocked**: Browser requests fail; use a server-side proxy (Cloudflare Worker)
...
- **Schema varies**: Modules and custom fields differ per installation

## See Also

- [Query patterns](references/queries.md)
- [Reporting patterns](references/reporting.md)
- [AI integration](references/ai-integration.md)
- [Related: fin/reporting](../../fin/reporting/SKILL.md)
